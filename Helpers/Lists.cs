...
namespace WholesomeDungeonCrawler.Helpers
{
    class Lists
    {
        internal static readonly List<DungeonModel> AllDungeons = new List<DungeonModel>
        {
            ...
            new DungeonModel { Name="The Forge of Souls", IsHeroic = true, DungeonId=252, MapId=632, ContinentId=571, EntranceLoc=new Vector3(5675.031, 1998.231, 798.0471, "None") },
            new DungeonModel { Name="Pit of Saron", IsHeroic = true, DungeonId=254, MapId=658, ContinentId=571, EntranceLoc=new Vector3(5586.841, 2006.409, 798.0458, "None") },
            new DungeonModel { Name="Halls of Reflection", IsHeroic = true, DungeonId=256, MapId=668, ContinentId=571, EntranceLoc=new Vector3(5626.953, 1964.744, 803.021, "None") },
        ...
        public static readonly Dictionary<int, SpecialPrio> SpecialPrioTargets = new Dictionary<int, SpecialPrio>
        {
            ...
            { 13456, new SpecialPrio(0, TargetPriority.High, true) }, // Noxxion's spawn (Maraudon Orange)
            { 13282, new SpecialPrio(0, TargetPriority.High, true) }, // Noxxion (Maraudon Orange)
            // TBC
