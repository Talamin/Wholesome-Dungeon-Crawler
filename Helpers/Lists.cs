...
namespace WholesomeDungeonCrawler.Helpers
{
    class Lists
    {
        internal static readonly List<DungeonModel> AllDungeons = new List<DungeonModel>
        {
            ...
            new DungeonModel { Name="Dire Maul West", DungeonId=36, MapId=429, ContinentId=1, EntranceLoc=new Vector3(-62.9658, 159.867, -3.464692, "None"), Start=new Vector3(31.5609, 159.45, -3.4777, "None") },
            ...
            new DungeonModel { Name="Dire Maul East", DungeonId=34, MapId=429, ContinentId=1, EntranceLoc=new Vector3(44.4499, -154.822, -2.71364, "None"), Start=new Vector3(44.4499, -154.822, -2.71364, "None")},
            ...
            new DungeonModel { Name="Trial of the Champion", DungeonId=245, MapId=650, ContinentId=571, EntranceLoc=new Vector3(0, 0,0, "None") },
            ...
            new DungeonModel { Name="Trial of the Champion", IsHeroic = true, DungeonId=249, MapId=650, ContinentId=571, EntranceLoc=new Vector3(0, 0,0, "None") },
