...
namespace WholesomeDungeonCrawler.Managers
{
    internal partial class AvoidSpellsManager : IAvoidAOEManager
    {
        ...
        ObjectManager.Target.CastingTimeLeft > 0;
        

        AIO.Helpers.Caching.Cache
        ...
        */
        ...
        private void RemoveAllDangerZones()
        {
            _dangerZones.Clear();
        }
        ...
        private void DrawEventAOE()
        {
            try
            {
                ...
                {
                    dangerZone.Draw(Color.OrangeRed, false, 150);
                }
